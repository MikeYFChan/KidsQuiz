// QUESTIONS_DATA - Static fallback for local file access (file://)
// Version: 1.1.0 - Updated Subject Structure & Content
  ...
  "English": {
    "Year 3": [
      {
        ...
        "choices": ["run", "table", "happily", "blue"],
        "correctIndex": 1
      },
      {
        ...
        "choices": ["jumping", "jumps", "jumped", "jump"],
        "correctIndex": 2
      },
      {
    ...
    "Year 6": [
      ...
      },
      {
        ...
        "choices": ["The boy kicked the ball.", "The ball was kicked by the boy.", "The boy is kicking.", "Kick the ball!"],
        "correctIndex": 1
      }
    ]
  },
      ...
      "Verbal Reasoning": [
        {
          ...
          "choices": ["Carrot", "Potato", "Broccoli", "Apple"],
          "correctIndex": 3
        }
      ],
      ...
      "KS2 English": [
        {
          ...
          "choices": ["The dog which was very tired fell asleep.", "The dog, which was very tired, fell asleep.", "The dog which was very tired, fell asleep.", "The dog, which was very tired fell asleep."],
          "correctIndex": 1
        }
      ]
    }
